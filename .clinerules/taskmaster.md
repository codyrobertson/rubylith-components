...
recommended MCP tools, suitable for integrations like Cline, and the corresponding `task-master` CLI
...
- **Usage:** Run this once at the beginning of a new project, typically via an integrated tool like
  Cline. Operates on the current working directory of the MCP server.
...
section of your **`.cline/mcp.json`** file (for MCP/Cline integration). All other settings (model
